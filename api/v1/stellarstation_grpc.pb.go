...
func (c *stellarStationServiceClient) ListPlans(ctx context.Context, in *ListPlansRequest, opts ...grpc.CallOption) (*ListPlansResponse, error) {
	...
	err := c.cc.Invoke(ctx, StellarStationService_ListPlans_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *stellarStationServiceClient) CancelPlan(ctx context.Context, in *CancelPlanRequest, opts ...grpc.CallOption) (*CancelPlanResponse, error) {
	...
	err := c.cc.Invoke(ctx, StellarStationService_CancelPlan_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *stellarStationServiceClient) ListUpcomingAvailablePasses(ctx context.Context, in *ListUpcomingAvailablePassesRequest, opts ...grpc.CallOption) (*ListUpcomingAvailablePassesResponse, error) {
	...
	err := c.cc.Invoke(ctx, StellarStationService_ListUpcomingAvailablePasses_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *stellarStationServiceClient) OpenSatelliteStream(ctx context.Context, opts ...grpc.CallOption) (StellarStationService_OpenSatelliteStreamClient, error) {
	stream, err := c.cc.NewStream(ctx, &StellarStationService_ServiceDesc.Streams[0], StellarStationService_OpenSatelliteStream_FullMethodName, opts...)
	if err != nil {
		return nil, err
	}
...
func (c *stellarStationServiceClient) ReservePass(ctx context.Context, in *ReservePassRequest, opts ...grpc.CallOption) (*ReservePassResponse, error) {
	...
	err := c.cc.Invoke(ctx, StellarStationService_ReservePass_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *stellarStationServiceClient) AddTle(ctx context.Context, in *AddTleRequest, opts ...grpc.CallOption) (*AddTleResponse, error) {
	...
	err := c.cc.Invoke(ctx, StellarStationService_AddTle_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *stellarStationServiceClient) GetTle(ctx context.Context, in *GetTleRequest, opts ...grpc.CallOption) (*GetTleResponse, error) {
	...
	err := c.cc.Invoke(ctx, StellarStationService_GetTle_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *stellarStationServiceClient) SetTleSource(ctx context.Context, in *SetTleSourceRequest, opts ...grpc.CallOption) (*SetTleSourceResponse, error) {
	...
	err := c.cc.Invoke(ctx, StellarStationService_SetTleSource_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *stellarStationServiceClient) SetPlanMetadata(ctx context.Context, in *SetPlanMetadataRequest, opts ...grpc.CallOption) (*SetPlanMetadataResponse, error) {
	...
	err := c.cc.Invoke(ctx, StellarStationService_SetPlanMetadata_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
// All implementations should embed UnimplementedStellarStationServiceServer
...
// UnimplementedStellarStationServiceServer should be embedded to have forward compatible implementations.
...
func (UnimplementedStellarStationServiceServer) OpenSatelliteStream(StellarStationService_OpenSatelliteStreamServer) error {
