...
type SatelliteStreamRequest struct {
	...
	// Optional. The telemetry index to resume from an previously opened stream. If the specified value is greater
	// than zero, server will attempt to resume transfer starting from the specified index. Otherwise,
	// server will attempt to resume transfer with first avaiable message. First index of a pass
	// always starts at one. This feature may not be available for Out-of-order-allowed-satellites.
	...
	ResumeTelemetryIndex uint64 `protobuf:"varint,8,opt,name=resume_telemetry_index,json=resumeTelemetryIndex,proto3" json:"resume_telemetry_index,omitempty"`
...
func (m *SatelliteStreamRequest) GetResumeTelemetryIndex() uint64 {
	if m != nil {
		return m.ResumeTelemetryIndex
	}
	return 0
}
...
type ReceiveTelemetryAck struct {
	...
	// The `Telemetry.index` value of the ReceiveTelemetryResponse to acknowledge
	TelemetryIndex uint64 `protobuf:"varint,2,opt,name=telemetry_index,json=telemetryIndex,proto3" json:"telemetry_index,omitempty"`
	// Optional. The local timestamp of message reception, used for statistics collection.
	ReceivedTimestamp    *timestamp.Timestamp `protobuf:"bytes,3,opt,name=received_timestamp,json=receivedTimestamp,proto3" json:"received_timestamp,omitempty"`
	XXX_NoUnkeyedLiteral struct{}             `json:"-"`
	XXX_unrecognized     []byte               `json:"-"`
	XXX_sizecache        int32                `json:"-"`
}
...
func (m *ReceiveTelemetryAck) GetPlanId() string {
	if m != nil {
		return m.PlanId
	}
	return ""
...
func (m *ReceiveTelemetryAck) GetTelemetryIndex() uint64 {
	if m != nil {
		return m.TelemetryIndex
	}
	return 0
}
...
var fileDescriptor_748aaec63a216ae0 = []byte{
	...
	,
}
