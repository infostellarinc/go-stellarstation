...
func (*Tle) Descriptor() ([]byte, []int) {
	return fileDescriptor_b12f80d8dcb682af, []int{0}
}
...
func init() {
	proto.RegisterFile("stellarstation/api/v1/orbit/orbit.proto", fileDescriptor_b12f80d8dcb682af)
}

var fileDescriptor_b12f80d8dcb682af = []byte{
